namespace Traverse.Team.Web.HttpModules
{
    using System;
    ...
    public class LangQueryAppenderModule : IHttpModule
    {
        ...
        public LangQueryAppenderModule()
        {
            ...
            var asmPath = HttpContext.Current.Server.MapPath("~/bin/Traverse.Team.Web.dll");
        ...
        private void Application_BeginRequest(Object source, EventArgs e)
        {
            try
            {
                ...
                {
                    var localisedUri = LocalizationHelper.GetLocalizedUrl(ctx.Request.Url, _controllersNamesList, ctx.Request.UserLanguages);
