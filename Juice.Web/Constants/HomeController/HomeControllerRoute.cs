namespace Juice.Web.Constants
{
    public static class HomeControllerRoute
    {
        ...
        public const string GetBrowse = ControllerName.Home + "GetBrowse";
        ...
        public const string GetProducts = ControllerName.Home + "GetProducts";
        ...
        public const string GetPrices = ControllerName.Home + "GetPrices";
        ...
        public const string GetStartPage = ControllerName.Home + "GetStartPage";
    }
}